...
class ForceController:
    ...
    def set_xyz_force(self, x_force, y_force, z_force):
        ...
        #print("req. throttle:", throttle)
        #print("Resulting vector", ))
        #rot_vector = rotation.apply((0,0,target_thrust))
        #self.plot_vectors([(0,0,target_thrust), target_vector, rot_vector ], colors=["g", "r", "b"], labels=["adj. thrust", "initial vec", "res vector"])
