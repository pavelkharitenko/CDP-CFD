"""
Position controller based on Nonlinear Feedback from Lee et al. "Hybrid model-based and data-driven disturbance
prediction for precise quadrotor trajectory tracking", https://dx.doi.org/10.1016/j.engappai.2024.108895
"""
...
class NonlinearFeedbackController3:
    ...
    def __init__(self, uav_mass=3.035, target_yaw=0.0, dt=0.005):
        ...
        self.k_p = np.array([2.0, 1.5, 10.0])
        self.k_v = np.array([1.0, 0.8, 10.0])
