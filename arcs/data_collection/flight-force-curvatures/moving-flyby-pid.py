...
from PID.controller import PID_Force_Controller
...
def main(controller):
    ...
    steps_per_call = int(1.0 / control_frequency / time_step) # Calculate time steps between one control period
    ...
    while curr_sim_time < sim_max_duration:
        ...
        if curr_sim_time < HOVER_TIME:
            ...
            px4_input_1 = (0.0, 0.0, -1.5, 0.6, nan, nan, nan, nan, nan, nan, 0.0, nan) 
        else:
            # keep set all acc to 0
            #px4_input_1 = (0.0, nan, nan, 0.6, nan, y_velocity, nan, 0.0, 0.0, 0.0, 0.0, nan) 
            #px4_input_1 = (0.0, nan,nan,nan, 0.0, 0.0, 0.0, nan, nan, nan, 0.0, nan)
            #px4_input_1 = pidc.set_xyz_force(0,0,0) 
            px4_input_1 = (2.0, 0, 0, 0, 0, 0.0, throttle)
        
        print("input is ", px4_input_1)
