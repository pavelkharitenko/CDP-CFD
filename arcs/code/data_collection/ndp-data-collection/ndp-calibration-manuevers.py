...
exp = load_forces_from_dataset("2024-10-03-12-25-46-ndp-2-P600-advanced-queue-30.0sec-906-ts.p")
...
while curr_sim_time < sim_max_duration:
    ...
    if FLY_CIRCULAR:
        ...
        px4_input_1 = waypoint_after([0.0,5],[(0,1.5,2),(0,-1.5,2)])
        px4_input_2 = waypoint_after([0.0],[(0,-1.5,1.0)])
