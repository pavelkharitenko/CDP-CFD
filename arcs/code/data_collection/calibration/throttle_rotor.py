...
def main(controller):
    ...
    # special variables
    r1_jft_sensor_idx = controller.get_sensor_info("uav_1_jft_sensor_rotor1").index
    r1_joint_sensor_vel_idx = controller.get_sensor_info("uav_1_joint_vel_sensor_rotor1").index
    ...
    while curr_sim_time < sim_max_duration:
        ...
        if FLY_CIRCULAR:
            ...
            if curr_sim_time < HOVER_TIME:
                ...
                px4_input_1 = (0.0, 0.0, .75, 1, nan, nan, nan, nan, nan, nan, 0.0, nan) 
            else:
                # keep position
                ...
                px4_input_1 = (1.0, qw, qx, qy, qz, 0, throttle) 
                
        # second drone just hovering
        px4_input_2 = (0.0, 0.0, -.75, 1.0, nan, nan, nan, nan, nan, nan, 0.0, nan)
        ...
        rotor_1_forces_list.append(reply.get_sensor_output(r1_jft_sensor_idx)[2])
        rotor_1_rps_list.append(reply.get_sensor_output(r1_joint_sensor_vel_idx)[0])
