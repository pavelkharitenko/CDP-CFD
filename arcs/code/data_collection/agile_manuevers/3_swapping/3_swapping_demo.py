...
def main(controller):
    # manuever specific
    MANUEVER_NAME = "3_swapping"
    dataset_name = MANUEVER_NAME + "_demo_150"
    ...
    sampled_y_vel = -2.0#-1.0*sample_from_range(y_vel_min,y_vel_max)
    initial_y_pos = 1.5 + sampled_y_vel*0.2
    selected_velocities.append(sampled_y_vel)
    ITERATION_TIME = HOVER_DURATION + 13.0/-sampled_y_vel

    #px4_input_1 = (0.0, initial_point[0], initial_y_pos, initial_point[2] + 0.5, nan, nan, nan, nan, nan, nan, yaw_uav_1, nan)
    px4_input_1 = (0.0, 0, initial_y_pos, 1.5, nan, nan, nan, nan, nan, nan, yaw_uav_1, nan) # uav 2 hover at (x,0,z)
    px4_input_2 = (0.0, 0.0, -initial_y_pos, 0.0, nan, nan, nan, nan, nan, nan, yaw_uav_2, nan) 
    ...
    while curr_sim_time < SIM_MAX_DURATION:
        ...
        if iteration_time > ITERATION_TIME or uav_1.states[-1][1] < y_pos_max:
            ...
            px4_input_1 = (0.0, 0.0, initial_y_pos, 1.5, nan, nan, nan, nan, nan, nan, yaw_uav_1, nan) # uav 2 hover at (x,0,z)
            px4_input_2 = (0.0, 0.0, -initial_y_pos, 0.0, nan, nan, nan, nan, nan, nan, yaw_uav_2, nan) # uav 2 hover at (0,0,0)
    ...
    extract_and_plot_data(None, None, np.array(time_seq), uav_1.states, uav_2.states,plot=True, roll_iterations=False, save=SAVE_EXP,
                          data_name=dataset_name + str(total_iterations) + "it")
