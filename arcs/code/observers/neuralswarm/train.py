#----------------------------------
# NDP model implemented from Shi et al. Neural-Swarm: Decentralized Close-Proximity 
# Multirotor Control using Learned Interactions
#----------------------------------
import torch, sys
...
n_epochs = 60000
evaluate_at_l_epochs = 2000
save_at_m_epochs = 40000
...
def train():
    ...
    exp_name = init_experiment(f"NSwarm-Model-sn_scale-{str(sn_gamma)}-144k-datapoints-corrected-bias")
    ...
    plot_zy_yx_slices_ns(model)
    plot_xy_slices_ns(model)
