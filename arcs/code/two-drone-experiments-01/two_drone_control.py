...
px4_index = controller.get_actuator_info('controller1').index

# Retrieve imu sensor index (imu is a class of sensor)
imu_index = controller.get_sensor_info('imu1').index
...
while (t < 20.0):
    ...
    nan = float('NaN')
    px4_input = (0.0, px, py, 0.0, nan, nan, nan, nan, nan, nan, 0.0, nan) # This is the actuator input vector
