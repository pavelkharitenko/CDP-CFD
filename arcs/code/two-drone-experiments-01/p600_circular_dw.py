...
while curr_sim_time < sim_max_duration:
    ...
    # Create controller 2 input. This is the actuator input vector
    px4_input_2 = (0.0, 0.0, 0.0, 1.0, nan, nan, nan, nan, nan, nan, 0.0, nan) 

    # uav 1  flies circle after 3.6s
    freq = 0.25
    radius = 1.0
    px = radius * np.sin(2.0 * np.pi * freq * curr_sim_time)
    py = radius - radius * np.cos(2.0 * np.pi * freq * curr_sim_time)
    if False: #curr_sim_time < 3.6:
        px4_input_1 = (0.0, 0.0, 1.5, 2.0, nan, nan, nan, nan, nan, nan, 0.0, nan) 
    else:
        px4_input_1 = (0.0, 0.0, 10, 2.0, nan, nan, nan, nan, nan, nan, 0.0, nan) 
